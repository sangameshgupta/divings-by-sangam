  ...
  return (
    <div className="px-6 max-w-7xl mx-auto">
      ...
      <section className="mb-24 pt-16">
        <span className="font-label text-secondary uppercase tracking-[0.2em] text-[11px] mb-4 block">
          Selected Works
        </span>
        <h1 className="text-5xl md:text-7xl font-black tracking-[-0.04em] font-headline mb-8 text-on-surface max-w-4xl">
          The Architectural{" "}
          <span className="text-primary">Monolith</span> of Digital Tools.
        </h1>
        <p className="text-on-surface/60 text-lg md:text-xl leading-relaxed max-w-2xl font-body">
